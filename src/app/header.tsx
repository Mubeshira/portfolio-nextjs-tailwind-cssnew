...
// function Header() {
//   return (
//   <header className='flex justify-between items-center p-5 bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% ...'>
//     <div>
//         <h1 className='text-3xl ml-9 italic'>Mubeshira</h1>
//     </div>

    
//         <ul>
            
//         <li className='space-x-4 mr-9'>
//             <Link href="/" className='hover:bg-white hover:text-black rounded-full p-2 '>Home</Link>
//             <Link href="/about"  className='hover:bg-white hover:text-black rounded-full p-2'>About</Link>
//             <Link href="/about"  className='hover:bg-white hover:text-black rounded-full p-2'>Projects</Link>
//             <Link href="/contact"  className='hover:bg-white hover:text-black rounded-full p-2'>Contact</Link>
//         </li>
//         </ul>
...
function Header() {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <nav className="absolute top-16 left-0 w-full bg-indigo-500 text-white flex flex-col items-center space-y-4 py-4 shadow-lg md:hidden">
